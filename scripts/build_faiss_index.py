"""Script to build and verify FAISS IndexFlatIP index wrapped with IndexIDMap2."""
...
def main() -> None:
    print("Loading embeddings and product IDs...")
    ...
    print("Reloading FAISS index to verify vector count...")
    ...
    print("FAISS index built and verified successfully.")
